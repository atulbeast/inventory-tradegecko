      ...
      <soap:Body>
        <AddOrder xmlns=\"http://sma-promail/\">
          <order>
            <Header>
              <ID>CS-TEST316</ID>
              <EntryDate>#{order_model.created_at}</EntryDate>
              <OrderEntryView>
                <Description>Default</Description>
              </OrderEntryView>
              <InsertDate>#{order_model.created_at}</InsertDate>
            </Header>
            <Classification>
              <Source>
            ...
            <OrderedBy>
              ...
              <TaxExempt>#{user_model.tax_exempt}</TaxExempt>
              <TaxExemptApproved>#{user_model.tax_exempt_approved}</TaxExemptApproved>
